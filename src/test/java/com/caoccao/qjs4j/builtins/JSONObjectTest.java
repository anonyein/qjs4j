...
public class JSONObjectTest extends BaseTest {
    ...
    public void testComplexJSON() {
        ...
        assertEquals("Alice", user1.get("name").asString().map(JSString::value).orElseThrow());
        assertEquals(30.0, user1.get("age").asNumber().map(JSNumber::value).orElseThrow());
        ...
        assertEquals("developer", tags1.get(0).asString().map(JSString::value).orElseThrow());
        assertEquals("admin", tags1.get(1).asString().map(JSString::value).orElseThrow());

        // Check metadata
        JSObject metadata = root.get("metadata").asObject().orElseThrow();
        assertEquals("1.0", metadata.get("version").asString().map(JSString::value).orElseThrow());
        assertEquals(2.0, metadata.get("count").asNumber().map(JSNumber::value).orElseThrow());
    ...
    public void testParse() {
        ...
        assertEquals("hello\nworld", result.asString().map(JSString::value).orElseThrow());
        ...
        assertEquals("two", arr.get(1).asString().map(JSString::value).orElseThrow());
        ...
        assertEquals("test", obj.get("name").asString().map(JSString::value).orElseThrow());
        assertEquals(123.0, obj.get("value").asNumber().map(JSNumber::value).orElseThrow());
        ...
        obj = result.asObject().orElseThrow();
        assertEquals("value", obj.get("key").asString().map(JSString::value).orElseThrow());
    ...
    public void testRoundTrip() {
        ...
        assertEquals("hello", parsedObj.get("string").asString().map(JSString::value).orElseThrow());
        assertEquals(42.0, parsedObj.get("number").asNumber().map(JSNumber::value).orElseThrow());
        ...
        assertEquals("item1", parsedArr.get(0).asString().map(JSString::value).orElseThrow());
        assertEquals(2.0, parsedArr.get(1).asNumber().map(JSNumber::value).orElseThrow());
    }
    ...
    public void testStringifyForObjects() {
        ...
        assertEquals("[1,\"two\",true]", result.asString().map(JSString::value).orElseThrow());
    ...
    public void testStringifyForPrimitives() {
        ...
        assertEquals("null", result.asString().map(JSString::value).orElseThrow());
        ...
        assertEquals("-123.45", result.asString().map(JSString::value).orElseThrow());
