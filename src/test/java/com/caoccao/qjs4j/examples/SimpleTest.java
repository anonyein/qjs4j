...
public class SimpleTest {
    ...
    public static void main(String[] args) {
        ...
        try (JSRuntime runtime = new JSRuntime(); JSContext context = runtime.createContext()) {
            ...
            JSValue result1 = context.eval("2 + 3");
            ...
            JSValue result2 = context.eval("var x = 10; var y = 20; x + y");
            ...
            JSValue result5 = context.eval("'hello world'.toUpperCase()");
            ...
            JSValue result6 = context.eval("parseInt('42')");
            assertEquals(42.0, (Double) result6.toJavaObject());
            System.out.println("parseInt('42') = " + result6);
            JSValue result7 = context.eval("parseFloat('3.14159')");
            ...
            JSValue result8 = context.eval("JSON.stringify({name: 'test', value: 42})");
            ...
            try {
                context.eval("throw new Error('Test error')");
