...
public final class GeneratorPrototype {
    ...
    public static JSValue next(JSContext ctx, JSValue thisArg, JSValue[] args) {
        if (!(thisArg instanceof JSGenerator generator)) {
            return ctx.throwError("TypeError", "Generator.prototype.next called on non-generator");
        }
     ...
     */
    public static JSValue returnMethod(JSContext ctx, JSValue thisArg, JSValue[] args) {
        if (!(thisArg instanceof JSGenerator generator)) {
            return ctx.throwError("TypeError", "Generator.prototype.return called on non-generator");
        }
     ...
     */
    public static JSValue throwMethod(JSContext ctx, JSValue thisArg, JSValue[] args) {
        if (!(thisArg instanceof JSGenerator generator)) {
            return ctx.throwError("TypeError", "Generator.prototype.throw called on non-generator");
        }
        ...
        try {
            ...
            return ctx.throwError("Error", e.getMessage());
        }
    }
}
