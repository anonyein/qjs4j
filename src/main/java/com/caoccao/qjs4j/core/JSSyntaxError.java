...
/**
 * Represents a JavaScript SyntaxError object.
 */
public final class JSSyntaxError extends JSError {

    public static final String NAME = "SyntaxError";

    /**
     * Create a SyntaxError with an empty message.
     */
    public JSSyntaxError(JSContext context) {
        this(context, "");
    }

    /**
     * Create a SyntaxError with a message.
     */
    public JSSyntaxError(JSContext context, String message) {
    ...
    public static JSObject create(JSContext context, JSValue... args) {
        ...
        JSObject jsObject = new JSSyntaxError(context, message);
    ...
    public static JSObject createPrototype(JSContext context, JSValue... args) {
        ...
        JSError errorPrototype = new JSSyntaxError(context);
